      ...
      <div className="all-features">
        <div className="feature">
          <div className="feature-info">
            ...
            <p>
              At IndieRoll, we believe in the true value of creativity. That's
              why we ensure 100% of the profits go directly to our creators.
              Your work, your earnings. Enjoy the freedom of a platform where
              every watch translates to direct income, supporting your passion
              and hard work without intermediaries.
            </p>
          </div>
        ...
        <div className="feature">
          <div className="feature-info">
            ...
            <p>
              ...
              attention. It's transparent, fair, and directly proportional to
              the love each creation receives.
            </p>
          </div>
